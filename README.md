...
**Boka-14 was designed by Subham** — the language concept, the philosophy, every keyword, the error-message personality, and the loop/function syntax decisions are his. This was a **vibecoded project**: Subham directed the design and iterated on it conversationally, and **Claude (Anthropic) wrote the Python implementation** — the lexer, parser, interpreter, and error system — based on that direction, testing it along the way to make sure it actually behaved the way it was designed to.
...
```bash
git clone https://github.com/YOUR_USERNAME/boka-14.git
cd boka-14
